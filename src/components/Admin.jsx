...
const Admin = () => {
  ...
  useEffect(() => {
    ...
    axios.get("https://crypto-backend-3k2b.onrender.com/api/rates") // Updated URL
  ...
  const handleSubmit = (e) => {
    ...
    axios.post("https://crypto-backend-3k2b.onrender.com/api/rates/update", formData) // Updated URL
      .then(response => {
